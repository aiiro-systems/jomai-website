      ...
      <ul>
        <li>
          <a
            ...
            href="https://jomai-artifacts-382046072211.s3.ap-northeast-1.amazonaws.com/v0.1.0/Jomai_0.1.1_aarch64.dmg"
          >
            <span role="img" aria-label="pizza">
              🍕
            </span>{' '}
            macOS (Appleシリコン) v0.1.1 ベータ版
          </a>
        </li>
        <li>
          <a
            onClick={() => handleDownloadClick('mac-intel')}
            href="https://jomai-artifacts-382046072211.s3.ap-northeast-1.amazonaws.com/v0.1.0/Jomai_0.1.1_x64.dmg"
          >
            <span role="img" aria-label="pancake">
              🥞
            </span>{' '}
            macOS (Intel) v0.1.1 ベータ版
          </a>
        </li>
      </ul>
      <p className="text-sm">
