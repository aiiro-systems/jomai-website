    ...
    >
      ...
      <p className='text-sm'>
        ...
        <section className='bg-white border-t border-gray-300 py-8'>
          ...
          <form action='#' className='pt-4 space-y-8' name='contact' method='POST' data-netlify='true'>
            <div>
            ...
            <div className='sm:col-span-2'>
              <label htmlFor='message' className='block mb-2 text-sm font-medium text-gray-900'>メッセージ</label>
              <textarea id='message' rows={6}
                        className='block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500'
                        placeholder='Leave a comment...'></textarea>
            </div>
            <button type='submit'
                    className='py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-gray-600 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300'>送信
            </button>
          </form>
      </section>
    </Main>
